...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"GoGo","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
exports.default = void 0;
exports.getTodayInfo = getTodayInfo;
function getTodayInfo(start) {
  var WEEKLEN = 7; // 一周7天为常量
  var oneDay = 1000 * 60 * 60 * 24; // 一天的毫秒时长
  var weekLeave; // 开学当天所在周剩余天数
  var weekStart; // 开学当天是星期几
  var today; // 今天
  var dateDiff; // 今天与开学当天日期差
  var startDate; // 开学之日，日期对象
  var weekInfo = {
    week: null,
    day: null
  };
  ...
  return {
    ...
    currentDate: "".concat(today.getFullYear(), "/").concat(today.getMonth() + 1, "/").concat(today.getDate())
  };
}
var _default = {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setTodayInfo: function setTodayInfo(state, data) {
