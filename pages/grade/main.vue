            ...
            <div class="scroll-wrapper">
              <div class="card">
                ...
                <div class="content">
                  ...
                  <div
                      class="text-center py-2"
                      v-else-if="currentGrades.length === 0"
                  >
                    <image
                        class="mb-3"
                        style="width: 350rpx;"
                  ...
                  <template v-else>
                    ...
                    >
                      ...
                      <span class="gray">{{ item.absoluteScore }}</span>
                    </div>
                  </template>
                </div>
              </div>
  ...
  methods: {
      ...
      try {
        ...
        if (code === "1000") {
          if (data.length === 0) {
            ...
            this.errorText = '当前学期没有成绩 (｡•ˇ‸ˇ•｡)'
          }
          this.currentGrades = data
        } else {
          this.error = true
          this.errorImage = '/static/images/empty-2.svg'
          if (code === "2001") {
        ...
        this.error = true
        this.errorImage = '/static/images/empty-1.png'
    ...
    async getAllGrades() {
      ...
      try {
        ...
        this.error2 = true
        this.errorImage2 = '/static/images/empty-1.png'
